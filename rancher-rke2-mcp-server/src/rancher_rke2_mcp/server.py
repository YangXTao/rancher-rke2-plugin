    ...
    *,
    ...
    server = MCPServer(
        ...
        instructions=(
            ...
            "for the same configuration, then creates the rancher2_cluster_v2 object and registers every "
            "custom node in the approved role order. All execution uses strict known-host SSH "
            "verification and the declared control container."
        ),
